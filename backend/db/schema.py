...
class LiveConditionData(models.Model):
    ...
    def __str__(self):
        return f"Live condition data for {self.patient.first_name} {self.patient.last_name} at {self.timestamp}"
...
class LiveConditionDataAudit(models.Model):
    ...
    def __str__(self):
        return f"{self.action} action for {self.patient.first_name} {self.patient.last_name} at {self.timestamp}"